...
const WithdrawForm: React.FC = () => {
    ...
    return (
        <div className={'flex items-center justify-center mt-12 w-11/12 sm:w-3/4 mx-auto mb-20'}>
            <div className={'flex flex-col items-center w-full sm:w-[600px] bg-[#16372b] p-4 sm:p-12 sm:pt-8 rounded-xl border border-black shadow-sm'}>
                ...
                {isWithdrawError && withdrawError && (
                    <div>
                        {withdrawError.toString()}
                    </div>
                )}
                    {isWithdrawPrepareError && withdrawPrepareError && (
                        <div>
                            {withdrawPrepareError.toString()}
                        </div>
                    )}
                </div>
            </div>
